...
class EventAdmin(admin.ModelAdmin):
  list_display = ['organization_name','event_name','event_time', 'event_duration', 'event_end_time', 'event_description', 'is_recurring', 'recursion_type', 'num_required', 'get_students_registered']
